...
date: "2024-06-02"
readingTime: "10min"
preview: "Every Website needs an Email Newsletter. MailChimp is a popular service for that. Here is how you can connect it to NextJS (via Axios) - and learn the Next-API and Server in the process!"
---
...
<div className="text-neutral-400 text-sm">
  June 2, 2024 - 7min - #mailchimp #email #axios #api #tutorial #webdev
</div>
...
Next API is the backend middleman between the client and the mailchimp api. This
makes sure that the private authorization data can not get accessed by the
browser.
...
style of explanation, feel free to subscribe to my breaking-updates-only
newsletter below:)
