...
export default function AboutPage() {
  return (
    <main className="max-w-2xl mx-auto pt-20 pb-12 px-4 grow ">
      ...
      <div className=" ">
      <ul className="text-orange-la mb-5 flex pb-1 font-medium ">
        <li>
      ...
      <h1 className="font-semibold text-3xl mb-1">Leon Andersen</h1>
      <h3 className="italic text-xl mb-7 font-light">
        "Creative power is head and heart working together."
      </h3>
      <p className="text-xl mb-7 text-balance c1:text-justify pb-4">
