...
- [HomeFeed](#homefeed)
- [Menu](#menu)
- [Subscribe Forms](#subscribe-forms)
- [404](#404)
...
it into `/src/styles/fonts`. Then just copy the structure from below and use
...
importing `next/font`, so the highest parent file possible is `Layout.js`.
...
export default function Layout ({ children }){
  return (
    <div
      ...
      className={`${myFont.className} example-utility`}
      role="region"
...
```
---
**Congratulations,** you now know how to build the basic components. Make
...
## <a id="references" href="#toc">References</a>
...
## <a id="insights" href="#toc"> Bonus: Learning Process Insights</a>

_From here on it's just documentation/ journaling insights for myself. I want
...
**Time spent with styling:** I was also insecure about maybe wasting time with
design experiments that went beyond my initial draft. However, there were a few
things that I just wasn't able to predict from the drafting stage. I am happy I
took my time with them, feeling confident with (Tailwind)CSS by now. Except for
a little fun with the 404 page, everything was in an appropriate range.
...
bigger picture. It's been a bit painful, but I feel way more confident about my
