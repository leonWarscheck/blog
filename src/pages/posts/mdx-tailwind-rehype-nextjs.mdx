...
_Check out the [Tailwind Typography Docs](https://github.com/tailwindlabs/tailwindcss-typography) for all styling options._

Now, its time to mount `MdxLayout`. Below the frontmatter, and above your content of _each_ .mdx file insert this `MDXPage` component:
...
export default function MDXPage({ children }) {
  ...
  return (
    <MdxLayout>
      ...
      <article className="text-justify">{children}</article> // Set styling specific
      for this post. Include article tag for SEO.
    </MdxLayout>
  );
}
...
<br />
### 3. <a href="#toc" id="rehype-pretty-code">
  Rehype Pretty Code
</a>
...
<br />
### 4. <a href="#toc" id="mdx-custom-elements">
  MDX Custom Elements
</a>
...
<br />
### 5. <a href="#toc" id="custom-colortheme">
  Custom Colortheme
</a>
