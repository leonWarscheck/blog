...
date: '2024-06-07'
readingTime: '11min'
preview: 'Setting up MDX in NextJS can be a bit of a struggle. Especially when you mix it with
Tailwind and Rehype Pretty Code, which at times interfere. Here is how you can set them up together in near harmony. (+ Custom Colortheme)'
...
<div className="text-neutral-400 text-sm">
  June 7, 2024 - 11min - #mdx #tailwindtypography #rehype #webdev #tutorial
</div>
