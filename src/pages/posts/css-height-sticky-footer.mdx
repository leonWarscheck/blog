...
<br />
### 2. <a id="css-debugging-strategies" href="#toc">
...
<br />
### 3. <a id="alternative-grid" href="#toc">
  Alternative: Try Grid
</a>
...
_nest your footer inside of your main_, which could be confusing for screenreaders
and SEO.
