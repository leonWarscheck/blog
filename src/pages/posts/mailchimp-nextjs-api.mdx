...
learn the Next API routes in the process!
...
- these
  [NextJS Installation settings,](/posts/nextjs-pages-blog-tutorial-2024#installation)
- and this
  [pages routing structure.](/posts/nextjs-pages-blog-tutorial-2024#routing)
