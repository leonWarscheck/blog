...
date: "2024-01-30"
readingTime: "10min"
preview: "Every Website needs an Email Newsletter. MailChimp is a popular service for that. Here is how you can connect it to NextJS with a custom SubscribeForm - and learn Next API routes in the process!"
---
...
Next API routes in the process!
<br/>
<a id="toc"></a>
### Table of Contents
