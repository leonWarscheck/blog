...
<br />
### <a id="custom-subscribeform" href="#toc">
  ...
  return (
    <form onSubmit={handleSubscribe}>
      ...
      <button onClick={onCancel}>
        {" "}
        // triggers conditional (un-)rendering of subForm component in Header.js
        Cancel
      </button>
    </form>
  );
...
<br />
### <a id="subscribeform-handler-setup" href="#toc">
...
<br />
### <a id="get-mailchimp-auth-data" href="#toc">
