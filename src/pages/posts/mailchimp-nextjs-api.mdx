---
title: "Mailchimp Newsletter Management & Custom SubscribeForm with NextJS | Next API Routes"
date: "2024-01-30"
readingTime: "10min"
...
## Mailchimp & Custom SubscribeForm with NextJS | Understand Next API
...
that. Here is how you can connect it to NextJS with a custom SubscribeForm - and learn the
...
- and this [pages routing structure.](/posts/nextjs-pages-blog-tutorial-2024#routing)
...
export default function SubscribeForm({ onCancel, onSubscribe }) {
  ...
  return (
    ...
    ><input
      ...
      // In this example you would render the messages overlaying the header buttons.
      {feedbackState === "success" && ( // Condition 2.
          <p>Success.&nbsp;<span>Thank&nbsp;you.</span></p> // You can get creative. I used a span to render 2 colors to match my header button design with the messages.
      )}
...
style of explanation, feel free to subscribe to my newsletter - in the
header - to experience the component you just studied:)
