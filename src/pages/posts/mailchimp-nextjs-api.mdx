...
date: "2024-01-30"
readingTime: "10min"
preview: "Every website needs an Email Newsletter. MailChimp is a popular service for that. Here is how you can connect it to NextJS with a custom SubscribeForm & API routes!"
---
...
<div className="text-neutral-400 text-sm">
  January 30, 2024 - 10min - #mailchimp #email #axios #api #tutorial #webdev
</div>
