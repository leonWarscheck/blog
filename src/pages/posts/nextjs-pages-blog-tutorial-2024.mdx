...
date: '2024-06-07'
readingTime: '34min'
preview: 'The step-by-step guide to how you can build a blog-website just like this
...
June 7, 2024 - 34min - #tutorial #blog #webdevelopment #docs
</div>
...
_tailwind-classes_ that I used in my [source code](https://github.com/leonAndersen/blog) on Github.
...
- <Link href="/posts/mailchimp-nextjs-api" className="underline">Mailchimp Newsletter Management in NextJS | Next API</Link>
...
```
[Here](/posts/mailchimp-nextjs-api) you can find my guide on how you can set up the NextJS API to
connect to MailChimp (a Newsletter Management Service).
...
- [LeonAndersen.com Source Code on Github](https://github.com/leonAndersen/blog)
