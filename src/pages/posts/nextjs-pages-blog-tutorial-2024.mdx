  ...
  return (
    <footer>
      <nav> // eventhough navbar is mostly associated with the header, navigation links in the footer are also usually a navbar
        ...
        <div> // on smaller screensizes this div replaces the previous sibling div
          <ul>
            <li>
              <Link href="/imprint">
                Imprint
...
### <a id="subscribe-forms" href="#main-building">Subscribe Forms</a>
...
[Here]() you can find my guide on how you can set up the NextJS API to
connected to MailChimp (a Newsletter Management Service).
...
- <Link href="some.link" className="underline"> MDX & Tailwind in Next 14 PAGES-routing (incl. Syntax Highlighting)</Link>
- <Link href="some.link" className="underline"> Mailchimp in NextJS | Understand API / Server</Link>
- <Link href="some.link" className="underline"> Blogpage Building Struggles: CSS positioning has been cursed... until now!</Link>
...
- TailwindCSS Docs
- LeonAndersen.com Source Code on Github
- Github Crashcourse by 
- Conventional Commits
- Accessibility MDN Article
- NextJS Pages Routing Crash Course by WebNinja
- Gimp for drafting your Blog design
- NextJS Docs: Installation
...
## <a id="insights" href="#toc">4. Bonus: Learning Process Insights</a>
...
- Make it a challenge to find written tutorials/ docs as first choice.
