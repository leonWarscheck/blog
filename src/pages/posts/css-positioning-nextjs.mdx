...
Of course you can keep everything that you've built. It is just about
experimenting on a clean slate in a different branch. 

Just `git add .` `git commit` your current branch and then`git checkout -b
...
```
This way you can edit 4 components in a single file for quick prototyping.
