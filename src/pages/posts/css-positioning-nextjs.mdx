...
```
This way you can edit 4 components in a single file for quick prototyping and
land quickly at insights that you can then transfer to your actual branch. It
