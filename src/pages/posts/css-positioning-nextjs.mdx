...
Another great way for clarity is to just build everything from scratch...almost. Of course you can keep everything that you've built. Just `git add .` `git commit` `git branch blank-slate` and delete everything except for 
