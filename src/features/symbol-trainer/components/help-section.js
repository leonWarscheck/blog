export default function HelpSection() {
  return (
    <section aria-label="help-section" className={`mx-auto flex w-full max-w-2xl grow px-4`}>
      <div className="prose prose-neutral prose-invert my-auto max-h-[54dvh] w-full max-w-2xl overflow-scroll text-neutral-400 prose-h2:text-neutral-400 prose-h3:font-bold prose-h3:text-neutral-400">
        ...
        <p>
          <span className="font-bold">Suggested progression: </span>Choose a
          full level (Level Number = multiple of 5) and try it a few times to
