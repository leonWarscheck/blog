...
export default function Page404() {
  ...
  return (
    <main className="grow flex flex-col mx-auto max-w-2xl pt-20 text-neutral-200">
      {/* prettier-ignore */}
...
NOT FOUND ERROR 404/ NOT FOUND ERROR 404<br/>
      ...
      <h2 className=" text-justify px-4 font-semibold c2:text-2xl  c2:max-w-2xl max-w-xs pt-20">
